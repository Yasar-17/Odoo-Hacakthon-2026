    ...
    <ToastProvider>
      <div className="min-h-screen bg-background">
        ...
        <main className="lg:ml-sidebar min-w-0">
          <div className="animate-fade-in-up max-w-[1440px] mx-auto px-margin-mobile md:px-gutter lg:px-container-padding py-stack-md lg:py-section-gap flex flex-col gap-section-gap">
            {children}
          </div>
        </main>
      </div>
